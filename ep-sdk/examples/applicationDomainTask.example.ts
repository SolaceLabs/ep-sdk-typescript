...
const epSdkApplicationDomainTask_ExecuteReturn_Present: IEpSdkApplicationDomainTask_ExecuteReturn = await epSdkApplicationDomainTaskPresent.execute();
...
const applicationDomainId = epSdkApplicationDomainTask_ExecuteReturn_Present.epObject.id;
console.log(`application domain exists, applicationDomainId = ${applicationDomainId}.`);
...
const epSdkApplicationDomainTask_ExecuteReturn_Absent: IEpSdkApplicationDomainTask_ExecuteReturn = await epSdkApplicationDomainTaskAbsent.execute();
