...
export interface IEpSdkEventApiTask_GetFuncReturn extends Omit<IEpSdkTask_GetFuncReturn, "epObject"> {
  epObject: EventApi | undefined;
}
export interface IEpSdkEventApiTask_CreateFuncReturn extends Omit<IEpSdkTask_CreateFuncReturn, "epObject" > {
  epObject: EventApi;
}
export interface IEpSdkEventApiTask_UpdateFuncReturn extends Omit<IEpSdkTask_UpdateFuncReturn, "epObject"> {
  epObject: EventApi;
}
export interface IEpSdkEventApiTask_DeleteFuncReturn extends Omit<IEpSdkTask_DeleteFuncReturn, "epObject"> {
  epObject: EventApi;
}
export interface IEpSdkEventApiTask_ExecuteReturn extends Omit<IEpSdkTask_ExecuteReturn, "epObject"> {
  epObject: EventApi;
}
...
export class EpSdkEventApiTask extends EpSdkTask {
  ...
  protected getEpObjectKeys(epObject: EventApi | undefined): IEpSdkTask_EpObjectKeys {
  ...
  protected async getFunc(epSdkEventApiTask_Keys: IEpSdkEventApiTask_Keys): Promise<IEpSdkEventApiTask_GetFuncReturn> {
    ...
    if(eventApi === undefined) return this.Empty_IEpSdkEventApiTask_GetFuncReturn;
  ...
  protected async isUpdateRequiredFunc(epSdkEventApiTask_GetFuncReturn: IEpSdkEventApiTask_GetFuncReturn ): Promise<IEpSdkTask_IsUpdateRequiredFuncReturn> {
    ...
    if(epSdkEventApiTask_GetFuncReturn.epObject === undefined) throw new EpSdkInternalTaskError(logName, this.constructor.name, 'epSdkEventApiTask_GetFuncReturn.epObject === undefined');
  ...
  protected async updateFunc(epSdkEventApiTask_GetFuncReturn: IEpSdkEventApiTask_GetFuncReturn): Promise<IEpSdkEventApiTask_UpdateFuncReturn> {
    ...
    if(epSdkEventApiTask_GetFuncReturn.epObject === undefined) throw new EpSdkInternalTaskError(logName, this.constructor.name, 'epSdkEventApiTask_GetFuncReturn.epObject === undefined');
    if(epSdkEventApiTask_GetFuncReturn.epObject.id === undefined) throw new EpSdkApiContentError(logName, this.constructor.name, 'epSdkEventApiTask_GetFuncReturn.epObject.id === undefined', {
  ...
  protected async deleteFunc(epSdkEventApiTask_GetFuncReturn: IEpSdkEventApiTask_GetFuncReturn): Promise<IEpSdkEventApiTask_DeleteFuncReturn> {
    ...
    if(this.isCheckmode()) {
      return {
        ...
        epObject: epSdkEventApiTask_GetFuncReturn.epObject,
        epObjectKeys: this.getEpObjectKeys(epSdkEventApiTask_GetFuncReturn.epObject)
      };
    }
  ...
  public async execute(): Promise<IEpSdkEventApiTask_ExecuteReturn> { 
    const epSdkTask_ExecuteReturn: IEpSdkEventApiTask_ExecuteReturn = await super.execute();
