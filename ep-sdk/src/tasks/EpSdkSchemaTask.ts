...
export interface IEpSdkSchemaTask_GetFuncReturn extends Omit<IEpSdkTask_GetFuncReturn, "epObject"> {
  epObject: SchemaObject | undefined;
}
export interface IEpSdkSchemaTask_CreateFuncReturn extends Omit<IEpSdkTask_CreateFuncReturn, "epObject" > {
  epObject: SchemaObject;
}
export interface IEpSdkSchemaTask_UpdateFuncReturn extends Omit<IEpSdkTask_UpdateFuncReturn, "epObject"> {
  epObject: SchemaObject;
}
export interface IEpSdkSchemaTask_DeleteFuncReturn extends Omit<IEpSdkTask_DeleteFuncReturn, "epObject"> {
  epObject: SchemaObject;
}
export interface IEpSdkSchemaTask_ExecuteReturn extends Omit<IEpSdkTask_ExecuteReturn, "epObject"> {
  epObject: SchemaObject;
}
...
export class EpSdkSchemaTask extends EpSdkTask {
  ...
  protected async getFunc(epSdkSchemaTask_Keys: IEpSdkSchemaTask_Keys): Promise<IEpSdkSchemaTask_GetFuncReturn> {
    ...
    if(schemaObject === undefined) return this.Empty_IEpSdkSchemaTask_GetFuncReturn;
  ...
  protected async isUpdateRequiredFunc(epSdkSchemaTask_GetFuncReturn: IEpSdkSchemaTask_GetFuncReturn ): Promise<IEpSdkTask_IsUpdateRequiredFuncReturn> {
    ...
    const requestedCompareObject: TEpSdkSchemaTask_CompareObject = this.createObjectSettings();
  ...
  protected async updateFunc(epSdkSchemaTask_GetFuncReturn: IEpSdkSchemaTask_GetFuncReturn): Promise<IEpSdkSchemaTask_UpdateFuncReturn> {
  ...
  protected async deleteFunc(epSdkSchemaTask_GetFuncReturn: IEpSdkSchemaTask_GetFuncReturn): Promise<IEpSdkSchemaTask_DeleteFuncReturn> {
    ...
    if(this.isCheckmode()) {
      return {
        ...
        epObject: epSdkSchemaTask_GetFuncReturn.epObject,
        epObjectKeys: this.getEpObjectKeys(epSdkSchemaTask_GetFuncReturn.epObject)
      };
    }
  ...
  public async execute(): Promise<IEpSdkSchemaTask_ExecuteReturn> { 
    const epSdkTask_ExecuteReturn: IEpSdkSchemaTask_ExecuteReturn = await super.execute();
